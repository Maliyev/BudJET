...
import { mockAnalyzeTransactions } from "./services/llmService";
...
function App() {
  ...
  async function handleRunAI() {
    const result = await mockAnalyzeTransactions(transactions);
        ...
        return (
          <div className="home-stack chat-home-wrapper">
            <section className="card chat-card-full-height">
              <Chat transactions={transactions} loading={loadingTransactions} />
            </section>
          </div>
    );
  } ////////////////////////////////////////////////
